...
const InforCourse: React.FC<InforCourseProps> = ({ auth, id, dispatch }) => {
  ...
  return <div className="profile__course">
    ...
    {/* Load more */}
    {
      !profile.loading && <LoadMoreButton stopLoadMore={profile.stopLoadMore as boolean} result={profile.result} total={profile.totalCourse} handleLoadMore={handleLoadMore} />
    }
  </div>;
};
